...
import { DEFAULT_DOWNLOAD_OPTIONS } from '@/lib/moodle/types';
...
export default function App() {
  ...
  const handleDownload = useCallback(async () => {
    ...
    browser.runtime.sendMessage({
      type: 'download-files',
      payload: { files: selected, options: DEFAULT_DOWNLOAD_OPTIONS },
    });
  }, [files, selectedIds]);
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col">
      {/* Header */}
      <header className="flex items-center gap-2 border-b border-gray-200 dark:border-gray-700 px-4 py-3 shrink-0">
          ...
          <>
            ...
            {!downloading && (
              ...
              >
                ...
                Download {selectedIds.size} file{selectedIds.size !== 1 ? 's' : ''} as ZIP
              </button>
            )}
          </>
        )}
